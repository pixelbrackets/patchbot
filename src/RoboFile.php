...
class RoboFile extends \Robo\Tasks
{
    ...
    ]): int
    {
        ...
        $yamlContent = '# Generated by patchbot discover on ' . date('Y-m-d H:i:s') . PHP_EOL;
        $yamlContent .= '# Source: GitLab ' . $namespaceType . ' "' . $namespace . '" at ' . $gitlabUrl . PHP_EOL;
        $yamlContent .= Yaml::dump(['repositories' => $repositories], 4, 2);
